...
export function FileContentDialog(props: {
  ...
  return <dialog ref={dialogRef} className="file-content-dialog">
    <form onSubmit={(ev) => {
      ev.preventDefault();
      setFileContent({
      ...
      <input id={titleId} defaultValue={fileContent.name} ref={titleInputRef} />
      <label htmlFor={contentId}>Content</label>
      <textarea id={contentId} defaultValue={fileContent.contents} ref={contentInputRef}/>
